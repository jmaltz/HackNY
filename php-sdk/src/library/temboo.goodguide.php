...
class GoodGuide_Query_Inputs extends Temboo_Inputs
{
   /**
    ...
    /**
     * Set the value for the APIFormat input for this Query choreography.
     *
    ...
    /**
     * Set the value for the SortBy input for this Query choreography.
     *
    ...
    /**
     * Set the value for the SortOrder input for this Query choreography.
     *
...
class GoodGuide_Query_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param GoodGuide_Query $choreo The choregraphy object for this execution.
     * @param GoodGuide_Query_Inputs|array $inputs (optional) Inputs as GoodGuide_Query_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
...
class GoodGuide_QueryByID extends Temboo_Choreography
{
     ...
     * Retrieves information about products based on a GoodGuide product ID.
     *
     * @param Temboo_Session $session The session that owns this QueryByID choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this QueryByID choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this QueryByID choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the QueryByID choreography.
 *
 * @package Temboo
 * @subpackage GoodGuide
 */
...
{
   /**
     * Inputs object with appopriate setters for the QueryByID choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIFormat input for this QueryByID choreography.
     *
    ...
    /**
     * Set the value for the APIKey input for this QueryByID choreography.
     *
     * @param string $value (required, string) The API KEy provided by GoodGuide.
     * @return GoodGuide_QueryByID_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ID input for this QueryByID choreography.
     *
...
/**
 * Execution object for the QueryByID choreography.
 *
 * @package Temboo
 * @subpackage GoodGuide
 */
class GoodGuide_QueryByID_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param GoodGuide_QueryByID $choreo The choregraphy object for this execution.
     * @param GoodGuide_QueryByID_Inputs|array $inputs (optional) Inputs as GoodGuide_QueryByID_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this QueryByID execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return GoodGuide_QueryByID_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the QueryByID choreography.
 *
 * @package Temboo
 * @subpackage GoodGuide
 */
...
class GoodGuide_QueryByUPC extends Temboo_Choreography
{
     ...
     * Retrieves information about products based on the product's UPC code.
     *
     * @param Temboo_Session $session The session that owns this QueryByUPC choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this QueryByUPC choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this QueryByUPC choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the QueryByUPC choreography.
 *
 * @package Temboo
 * @subpackage GoodGuide
 */
...
{
   /**
     * Inputs object with appopriate setters for the QueryByUPC choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIFormat input for this QueryByUPC choreography.
     *
    ...
    /**
     * Set the value for the APIKey input for this QueryByUPC choreography.
     *
     * @param string $value (required, string) The API KEy provided by GoodGuide.
     * @return GoodGuide_QueryByUPC_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the UPC input for this QueryByUPC choreography.
     *
...
/**
 * Execution object for the QueryByUPC choreography.
 *
 * @package Temboo
 * @subpackage GoodGuide
 */
class GoodGuide_QueryByUPC_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param GoodGuide_QueryByUPC $choreo The choregraphy object for this execution.
     * @param GoodGuide_QueryByUPC_Inputs|array $inputs (optional) Inputs as GoodGuide_QueryByUPC_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this QueryByUPC execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return GoodGuide_QueryByUPC_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the QueryByUPC choreography.
 *
 * @package Temboo
 * @subpackage GoodGuide
 */
