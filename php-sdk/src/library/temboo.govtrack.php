...
class GovTrack_Role extends Temboo_Choreography
{
     ...
     * Returns terms held in office by Members of Congress and U.S. Presidents.
     *
     * @param Temboo_Session $session The session that owns this Role choreography.
     ...
     *
     * Execution object provides access to results appropriate for this Role choreography.
     *
     ...
     *
     * Includes setters appropriate for this Role choreography.
     *
...
/**
 * Inputs object with appropriate setters for the Role choreography.
 *
 * @package Temboo
 * @subpackage GovTrack
 */
...
{
   /**
     * Inputs object with appopriate setters for the Role choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the Current input for this Role choreography.
     *
    ...
    /**
     * Set the value for the District input for this Role choreography.
     *
    ...
    /**
     * Set the value for the EndDate input for this Role choreography.
     *
    ...
    /**
     * Set the value for the Limit input for this Role choreography.
     *
    ...
    /**
     * Set the value for the Order input for this Role choreography.
     *
    ...
    /**
     * Set the value for the Party input for this Role choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this Role choreography.
     *
    ...
    /**
     * Set the value for the RoleID input for this Role choreography.
     *
    ...
    /**
     * Set the value for the RoleType input for this Role choreography.
     *
    ...
    /**
     * Set the value for the SenatorClass input for this Role choreography.
     *
    ...
    /**
     * Set the value for the StartDate input for this Role choreography.
     *
    ...
    /**
     * Set the value for the State input for this Role choreography.
     *
...
/**
 * Execution object for the Role choreography.
 *
 * @package Temboo
 * @subpackage GovTrack
 */
class GovTrack_Role_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param GovTrack_Role $choreo The choregraphy object for this execution.
     * @param GovTrack_Role_Inputs|array $inputs (optional) Inputs as GovTrack_Role_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this Role execution.
     *
...
/**
 * Results object with appopriate getters for the Role choreography.
 *
 * @package Temboo
 * @subpackage GovTrack
 */
...
class GovTrack_VoteAndVoter extends Temboo_Choreography
{
     ...
     * Retrieves how people voted on roll call votes in the U.S. Congress since 1789. 
     *
     * @param Temboo_Session $session The session that owns this VoteAndVoter choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this VoteAndVoter choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this VoteAndVoter choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the VoteAndVoter choreography.
 *
 * @package Temboo
 * @subpackage GovTrack
 */
...
{
   /**
     * Inputs object with appopriate setters for the VoteAndVoter choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the Created input for this VoteAndVoter choreography.
     *
    ...
    /**
     * Set the value for the Limit input for this VoteAndVoter choreography.
     *
     * @param int $value (optional, integer) Results are paged 20 per call by default. Set the limit input to a high value to get all of the results at once.
     * @return GovTrack_VoteAndVoter_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ObjectID input for this VoteAndVoter choreography.
     *
    ...
    /**
     * Set the value for the Option input for this VoteAndVoter choreography.
     *
    ...
    /**
     * Set the value for the Order input for this VoteAndVoter choreography.
     *
     * @param string $value (optional, string) You can order the results by date using fieldname (ascending) or -fieldname (descending), where "fieldname" is either startdate or enddate.
     * @return GovTrack_VoteAndVoter_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Person input for this VoteAndVoter choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this VoteAndVoter choreography.
     *
     * @param string $value (optional, string) Specify the format of the response. Default is JSON, but XML is also possible.
     * @return GovTrack_VoteAndVoter_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Vote input for this VoteAndVoter choreography.
     *
...
/**
 * Execution object for the VoteAndVoter choreography.
 *
 * @package Temboo
 * @subpackage GovTrack
 */
class GovTrack_VoteAndVoter_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param GovTrack_VoteAndVoter $choreo The choregraphy object for this execution.
     * @param GovTrack_VoteAndVoter_Inputs|array $inputs (optional) Inputs as GovTrack_VoteAndVoter_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this VoteAndVoter execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return GovTrack_VoteAndVoter_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the VoteAndVoter choreography.
 *
 * @package Temboo
 * @subpackage GovTrack
 */
...
class GovTrack_Bill extends Temboo_Choreography
{
     ...
     * Retrieves bills and resolutions in the U.S. Congress since 1973 (the 93rd Congress).
     *
     * @param Temboo_Session $session The session that owns this Bill choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this Bill choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this Bill choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the Bill choreography.
 *
 * @package Temboo
 * @subpackage GovTrack
 */
...
{
   /**
     * Inputs object with appopriate setters for the Bill choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the BillID input for this Bill choreography.
     *
    ...
    /**
     * Set the value for the BillType input for this Bill choreography.
     *
    ...
    /**
     * Set the value for the Congress input for this Bill choreography.
     *
    ...
    /**
     * Set the value for the CurrentStatusDate input for this Bill choreography.
     *
    ...
    /**
     * Set the value for the CurrentStatus input for this Bill choreography.
     *
    ...
    /**
     * Set the value for the IntroducedDate input for this Bill choreography.
     *
    ...
    /**
     * Set the value for the Limit input for this Bill choreography.
     *
     * @param int $value (optional, integer) Results are paged 20 per call by default. Set the limit input to a high value to get all of the results at once.
     * @return GovTrack_Bill_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Number input for this Bill choreography.
     *
    ...
    /**
     * Set the value for the Order input for this Bill choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this Bill choreography.
     *
     * @param string $value (optional, string) Specify the format of the response. Default is JSON, but XML is also possible.
     * @return GovTrack_Bill_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the SchedulePostdate input for this Bill choreography.
     *
    ...
    /**
     * Set the value for the Sponsor input for this Bill choreography.
     *
...
/**
 * Execution object for the Bill choreography.
 *
 * @package Temboo
 * @subpackage GovTrack
 */
class GovTrack_Bill_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param GovTrack_Bill $choreo The choregraphy object for this execution.
     * @param GovTrack_Bill_Inputs|array $inputs (optional) Inputs as GovTrack_Bill_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this Bill execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return GovTrack_Bill_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the Bill choreography.
 *
 * @package Temboo
 * @subpackage GovTrack
 */
...
class GovTrack_Vote extends Temboo_Choreography
{
     ...
     * Returns roll call votes in the U.S. Congress since 1789.
     *
     * @param Temboo_Session $session The session that owns this Vote choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this Vote choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this Vote choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the Vote choreography.
 *
 * @package Temboo
 * @subpackage GovTrack
 */
...
{
   /**
     * Inputs object with appopriate setters for the Vote choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the Category input for this Vote choreography.
     *
    ...
    /**
     * Set the value for the Chamber input for this Vote choreography.
     *
    ...
    /**
     * Set the value for the Congress input for this Vote choreography.
     *
     * @param int $value (optional, integer) The number of the congress in which the bill was introduced. The current congress is 112.
     * @return GovTrack_Vote_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Created input for this Vote choreography.
     *
    ...
    /**
     * Set the value for the Limit input for this Vote choreography.
     *
     * @param int $value (optional, integer) Results are paged 20 per call by default. Set the limit input to a high value to get all of the results at once.
     * @return GovTrack_Vote_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Number input for this Vote choreography.
     *
    ...
    /**
     * Set the value for the Order input for this Vote choreography.
     *
    ...
    /**
     * Set the value for the RelatedBill input for this Vote choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this Vote choreography.
     *
     * @param string $value (optional, string) Specify the format of the response. Default is JSON, but XML is also possible.
     * @return GovTrack_Vote_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Session input for this Vote choreography.
     *
    ...
    /**
     * Set the value for the VoteID input for this Vote choreography.
     *
...
/**
 * Execution object for the Vote choreography.
 *
 * @package Temboo
 * @subpackage GovTrack
 */
class GovTrack_Vote_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param GovTrack_Vote $choreo The choregraphy object for this execution.
     * @param GovTrack_Vote_Inputs|array $inputs (optional) Inputs as GovTrack_Vote_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this Vote execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return GovTrack_Vote_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the Vote choreography.
 *
 * @package Temboo
 * @subpackage GovTrack
 */
...
class GovTrack_Person extends Temboo_Choreography
{
     ...
     * Returns members of Congress and U.S. Presidents since the founding of the nation.
     *
     * @param Temboo_Session $session The session that owns this Person choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this Person choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this Person choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the Person choreography.
 *
 * @package Temboo
 * @subpackage GovTrack
 */
...
{
   /**
     * Inputs object with appopriate setters for the Person choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the FirstName input for this Person choreography.
     *
    ...
    /**
     * Set the value for the Gender input for this Person choreography.
     *
    ...
    /**
     * Set the value for the LastName input for this Person choreography.
     *
    ...
    /**
     * Set the value for the Limit input for this Person choreography.
     *
     * @param int $value (optional, integer) Results are paged 20 per call by default. Set the limit input to a high value to get all of the results at once.
     * @return GovTrack_Person_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the MetaVidID input for this Person choreography.
     *
    ...
    /**
     * Set the value for the MiddleName input for this Person choreography.
     *
    ...
    /**
     * Set the value for the NameMod input for this Person choreography.
     *
    ...
    /**
     * Set the value for the OSID input for this Person choreography.
     *
    ...
    /**
     * Set the value for the PVSID input for this Person choreography.
     *
    ...
    /**
     * Set the value for the PersonID input for this Person choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this Person choreography.
     *
     * @param string $value (optional, string) Specify the format of the response. Default is JSON, but XML is also possible.
     * @return GovTrack_Person_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Roles input for this Person choreography.
     *
    ...
    /**
     * Set the value for the TwitterID input for this Person choreography.
     *
    ...
    /**
     * Set the value for the YoutubeID input for this Person choreography.
     *
...
/**
 * Execution object for the Person choreography.
 *
 * @package Temboo
 * @subpackage GovTrack
 */
class GovTrack_Person_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param GovTrack_Person $choreo The choregraphy object for this execution.
     * @param GovTrack_Person_Inputs|array $inputs (optional) Inputs as GovTrack_Person_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this Person execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return GovTrack_Person_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the Person choreography.
 *
 * @package Temboo
 * @subpackage GovTrack
 */
