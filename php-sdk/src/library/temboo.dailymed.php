...
class DailyMed_Query_Inputs extends Temboo_Inputs
{
   /**
    ...
    /**
     * Set the value for the Components input for this Query choreography.
     *
    ...
    /**
     * Set the value for the SetID input for this Query choreography.
     *
...
class DailyMed_Query_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param DailyMed_Query $choreo The choregraphy object for this execution.
     * @param DailyMed_Query_Inputs|array $inputs (optional) Inputs as DailyMed_Query_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
...
class DailyMed_GetComponents extends Temboo_Choreography
{
     ...
     * Returns imprint data associated with a given National Drug Code (NDC) in the DailyMed database.
     *
     * @param Temboo_Session $session The session that owns this GetComponents choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetComponents choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetComponents choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetComponents choreography.
 *
 * @package Temboo
 * @subpackage DailyMed
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetComponents choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the SetID input for this GetComponents choreography.
     *
     * @param string $value (required, string) The unique ID assigned by DailyMed to each drug. You can find the SetID of a drug by first running the SearchByName or SearchByNDC Choreos.
     * @return DailyMed_GetComponents_Inputs For method chaining.
     */
...
/**
 * Execution object for the GetComponents choreography.
 *
 * @package Temboo
 * @subpackage DailyMed
 */
class DailyMed_GetComponents_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param DailyMed_GetComponents $choreo The choregraphy object for this execution.
     * @param DailyMed_GetComponents_Inputs|array $inputs (optional) Inputs as DailyMed_GetComponents_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetComponents execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return DailyMed_GetComponents_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetComponents choreography.
 *
 * @package Temboo
 * @subpackage DailyMed
 */
...
class DailyMed_SearchByNDC extends Temboo_Choreography
{
     ...
     * Returns a list of drugs in the DailyMed database associated with a given National Drug Code (NDC).
     *
     * @param Temboo_Session $session The session that owns this SearchByNDC choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this SearchByNDC choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this SearchByNDC choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the SearchByNDC choreography.
 *
 * @package Temboo
 * @subpackage DailyMed
 */
...
{
   /**
     * Inputs object with appopriate setters for the SearchByNDC choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the NDC input for this SearchByNDC choreography.
     *
    ...
    /**
     * Set the value for the OutputFormat input for this SearchByNDC choreography.
     *
...
/**
 * Execution object for the SearchByNDC choreography.
 *
 * @package Temboo
 * @subpackage DailyMed
 */
class DailyMed_SearchByNDC_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param DailyMed_SearchByNDC $choreo The choregraphy object for this execution.
     * @param DailyMed_SearchByNDC_Inputs|array $inputs (optional) Inputs as DailyMed_SearchByNDC_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this SearchByNDC execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return DailyMed_SearchByNDC_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the SearchByNDC choreography.
 *
 * @package Temboo
 * @subpackage DailyMed
 */
...
class DailyMed_SearchByName_Inputs extends Temboo_Inputs
{
   /**
    ...
    /**
     * Set the value for the DrugName input for this SearchByName choreography.
     *
    ...
    /**
     * Set the value for the LabelType input for this SearchByName choreography.
     *
    ...
    /**
     * Set the value for the OutputFormat input for this SearchByName choreography.
     *
     * @param string $value (optional, string) Defaults to XML format when nothing is specified. Acceptable values: xml or json.
     * @return DailyMed_SearchByName_Inputs For method chaining.
     */
...
class DailyMed_SearchByName_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param DailyMed_SearchByName $choreo The choregraphy object for this execution.
     * @param DailyMed_SearchByName_Inputs|array $inputs (optional) Inputs as DailyMed_SearchByName_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
